...
return null;const fn=this.MEMORY[get].value;let i=0;this.MEMORY[get]?.arg?._Children?.forEach(argname=>{this.#mem_add(argname._Value,this.format(argname._Children[0]._Value,this.ParseAST(arg._Children[i]).value),null,fn);i=i+1;});return this.Execute(fn);}#mem_add(name,value,arg,access){let get=this.#mem_get(name,access);if(get!=null){this.MEMORY[get].value=value;this.MEMORY[get].arg=arg;return get;}
